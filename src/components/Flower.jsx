...
export const Flower = () => {
  ...
  const sectionRef = useRef(null); // Crear una referencia para el elemento <section>

  useEffect(() => {
    // Cuando el componente se monta, eliminamos el className del <section>
    if (sectionRef.current) {
      sectionRef.current.removeAttribute('class');
    }
  }, []);
